...
var BCDClock =
{
	...
	setHours: function(hours)
	{
		...
		this.setLedBin(0,this.toBinary(hours[0]));
		this.setLedBin(1,this.toBinary(hours[1]));		
	},
	...
	setMinutes: function(minutes)
	{
		...
		this.setLedBin(2,this.toBinary(minutes[0]));
		this.setLedBin(3,this.toBinary(minutes[1]));		
	},
	...
	setSeconds: function(seconds)
	{
		...
		this.setLedBin(4,this.toBinary(seconds[0]));
		this.setLedBin(5,this.toBinary(seconds[1]));		
	},
